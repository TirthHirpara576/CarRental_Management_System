            ...
            <div className='flex flex-wrap justify-between item-start gap-8 pb-6 border-borderColor border-b'>
                <div>
                    ...
                    <p className='max-w-80 mt-3'>
                        Rent a Car from the best brands in the business. Affordable & Reliable.
                    </p>
                ...
                <div>
                    ...
                    <ul className='mt-3 flex flex-col gap-1.5'>
                        <li>604, IT Park, Mota Bazar</li>
                        <li>Vadodara, Gujarat</li>
                        <li><a href="#">+91 9256738290</a></li>
                        <li><a href="#">praful576@gmail.com</a></li>
                    </ul>
                </div>
